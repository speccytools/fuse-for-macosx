...
static xkeyboard_key_info xkeyboard_data[] = {
  ...
  { XK_apostrophe , 7, 0x02, 4, 0x08 }, /* SS + 7 */
  { XK_numbersign , 7, 0x02, 3, 0x04 }, /* SS + 3 */
  ...
  { XK_n	  , 7, 0x08, 0, 0x00 },
  { XK_m	  , 7, 0x04, 0, 0x00 },
  { XK_comma      , 7, 0x02, 7, 0x08 }, /* SS + N */
  { XK_period     , 7, 0x02, 7, 0x04 }, /* SS + M */
  ...
  { XK_Mode_switch, 7, 0x02, 0, 0x00 }, /* SS */
...
{
  KeySym keysym; xkeyboard_key_info *ptr;
  int foundKey=0;
