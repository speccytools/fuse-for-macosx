...
settings_get_rom_setting( settings_info *settings, size_t which )
{
  ...
  case 27: return &( settings->rom_scorpion_0 );
  case 28: return &( settings->rom_scorpion_1 );
  case 29: return &( settings->rom_scorpion_2 );
  case 30: return &( settings->rom_scorpion_3 );
  case 31: return &( settings->rom_spec_se_0 );
