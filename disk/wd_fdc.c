...
int
wd_fdc_event( libspectrum_dword last_tstates, event_type event, void *user_data ) 
{
  wd_fdc *f = user_data;
...
wd_fdc_cr_write( wd_fdc *f, libspectrum_byte b )
{
  ...
  event_remove_type( EVENT_TYPE_WD_FDC_MOTOR_OFF );	/* keep spindle motor on */
